#ifndef STRINGMANIPULATIONCONSTANTS_H
#define STRINGMANIPULATIONCONSTANTS_H

namespace StringManipulation {
namespace Constants {

const char SEARCH_IN_GOOGLE[] = "StringManipulation.SearchInGoogle";
...
const char ADD_RETURN_ADDRESS[] = "StringManipulation.AddReturnAddress";
...
#endif // STRINGMANIPULATIONCONSTANTS_H
